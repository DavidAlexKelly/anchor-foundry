...
| **Networking / egress policies** | how target systems are reached | ◑ §263 `egress_policies` — the rule, the store and all four outbound paths; the panel is §264 |
