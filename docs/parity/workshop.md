...
Ours in the right-hand column. **25 of ~52 rows below are ✅ or ◑** — counted from the table rather than carried forward, because the number written here had drifted six behind it by §212 and a tally nobody recomputes is worse than no tally.
