...
5. **Object View widget, Property List, Links, Object Set Title** — **Object Set Title is done (§210)**; it turned out not to depend on ontology work at all, only on the object set variables and title properties that already existed. The other three still do: the Object View widget wants `ontology.md`'s Object Views, and Property List and Links want a property/link renderer that is the same work the standard Object View needs
